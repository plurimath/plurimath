...
RSpec.describe Plurimath::Math::Symbols::Paren::UpcaseRangle do

  describe ".initialize" do
    it 'returns instance of paren symbol UpcaseRangle' do
      klass = described_class.new
      expect(klass).to be_a(Plurimath::Math::Symbols::Paren::UpcaseRangle)
    end
  end
  ...
  describe ".open?, .close?, .opening" do
    ...
    context "matches if open paren for the Symbol Plurimath::Math::Symbols::Paren::UpcaseRangle" do
