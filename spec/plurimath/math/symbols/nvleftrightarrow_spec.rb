...
RSpec.describe Plurimath::Math::Symbols::Nvleftrightarrow do

  describe ".initialize" do
    it 'returns instance of Symbol Nvleftrightarrow' do
      klass = described_class.new
      expect(klass).to be_a(Plurimath::Math::Symbols::Nvleftrightarrow)
    end
  end
