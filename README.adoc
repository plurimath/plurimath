...
----
==== Note:
====== Asciimath doesn't support link:Latex-Symbols-Support.adoc[following symbols] but Latex does.So from Latex to Asciimath conversion we are returning latex's supported symbols if it's not supported in Asciimath.
