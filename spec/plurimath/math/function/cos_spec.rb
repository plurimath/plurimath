...
RSpec.describe Plurimath::Math::Function::Cos do
  describe ".initialize" do
    it "returns instance of Cos" do
      cos = described_class.new("70")
      expect(cos).to be_a(described_class)
    end
  ...
  describe ".to_asciimath" do
    ...
    context "contains Formula as value" do
      ...
      it "returns asciimath string" do
        expect(formula).to eq("cossum_(&)^(\"so\")")
      end
    end
  end
  ...
  describe ".to_latex" do
    ...
    context "contains Formula as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("\\cos{\\sum_{\\&}^{\\text{so}}}")
      end
    end
  end
  ...
  describe ".to_html" do
    ...
    context "contains Symbol as value" do
      ...
      it "returns html string" do
        expect(formula).to eql("<i>cos</i><i>n</i>")
      end
    end
    ...
    context "contains Number as value" do
      ...
      it "returns html string" do
        expect(formula).to eql("<i>cos</i><i>70</i>")
      end
    end
    ...
    context "contains Formula as value" do
      ...
      it "returns html string" do
        expect(formula).to eql("<i>cos</i><i><i>&sum;</i><sub>&</sub><sup>so</sup></i>")
      end
    end
  end
