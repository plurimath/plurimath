...
RSpec.describe Plurimath::Math::Function::F do
  ...
  describe ".initialize" do
    ...
    it 'initializes F object' do
      f = Plurimath::Math::Function::F.new('70')
      expect(f.parameter_one).to eql('70')
    end
  end
  ...
  describe ".to_latex" do
    ...
    context "contains Formula as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("f\\sum_{&}^{\\text{so}}")
      end
    end
  end
  ...
  describe ".to_html" do
    ...
    context "contains Symbol as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("<i>f</i><i>n</i>")
      end
    end
    ...
    context "contains Number as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("<i>f</i><i>70</i>")
      end
    end
    ...
    context "contains Formula as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("<i>f</i><i><i>&sum;</i><sub>&</sub><sup>so</sup></i>")
      end
    end
  end
end
