  ...
  describe ".to_asciimath .to_latex .to_mathml" do
    ...
    context "contains table with surrounding parentheses(metanorma example) and sqrt tag Mathml" do
      ...
      it 'returns Mathml string' do
        ...
        MATHML
        latex = "\\text{Convert} ( x , y , z , p_{a} , p_{o} , R , S , T ) = R_{z} ( \\alpha ) R_{y} ( \\beta ) R_{x} ( \\gamma ) S ( x - a_{x} , y - a_{y} , z - a_{z} ) + p_{o} + T =\\\\  \\left [\\begin{matrix}\\cos{__{funcapply}} \\alpha \\cos{\\beta} & \\cos{__{funcapply}} \\alpha \\sin{__{funcapply}} \\beta \\sin{__{funcapply}} \\gamma - \\sin{__{funcapply}} \\alpha \\cos{\\gamma} & \\cos{__{funcapply}} \\alpha \\sin{__{funcapply}} \\beta \\cos{__{funcapply}} \\gamma + \\sin{__{funcapply}} \\alpha \\sin{__{funcapply}} \\gamma \\\\ \\sin{__{funcapply}} \\alpha \\cos{__{funcapply}} \\beta & \\sin{__{funcapply}} \\alpha \\sin{__{funcapply}} \\beta \\sin{__{funcapply}} \\gamma + \\cos{__{funcapply}} \\alpha \\cos{__{funcapply}} \\gamma & \\sin{__{funcapply}} \\alpha \\sin{__{funcapply}} \\beta \\cos{__{funcapply}} \\gamma - \\cos{__{funcapply}} \\alpha \\sin{__{funcapply}} \\gamma \\\\ - \\sin{__{funcapply}} \\beta & \\text{“cos ⁡”} \\beta \\sin{__{funcapply}} \\gamma & \\cos{__{funcapply}} \\beta \\cos{__{funcapply}} \\gamma\\end{matrix}\\right ] \\left [\\begin{matrix}s_{x} \\ast ( x - a_{x} ) \\\\ s_{y} \\ast ( y - a_{y} ) \\\\ s_{z} \\ast ( z - a_{z} )\\end{matrix}\\right ] + \\left [\\begin{matrix}x_{0} + t_{x} \\\\ y_{0} + t_{y} \\\\ z_{0} + t_{z}\\end{matrix}\\right ] \\sqrt{d}"
        asciimath = "\"Convert\" (x , y , z , p_(a) , p_(o) , R , S , T) = R_(z) (alpha) R_(y) (beta) R_(x) (gamma) S (x - a_(x) , y - a_(y) , z - a_(z)) + p_(o) + T =\\\n  [[cos__{funcapply} alpha cosbeta, cos__{funcapply} alpha sin__{funcapply} beta sin__{funcapply} gamma - sin__{funcapply} alpha cosgamma, cos__{funcapply} alpha sin__{funcapply} beta cos__{funcapply} gamma + sin__{funcapply} alpha sin__{funcapply} gamma], [sin__{funcapply} alpha cos__{funcapply} beta, sin__{funcapply} alpha sin__{funcapply} beta sin__{funcapply} gamma + cos__{funcapply} alpha cos__{funcapply} gamma, sin__{funcapply} alpha sin__{funcapply} beta cos__{funcapply} gamma - cos__{funcapply} alpha sin__{funcapply} gamma], [- sin__{funcapply} beta, \"“cos ⁡”\" beta sin__{funcapply} gamma, cos__{funcapply} beta cos__{funcapply} gamma]] [[s_(x) ast (x - a_(x))], [s_(y) ast (y - a_(y))], [s_(z) ast (z - a_(z))]] + [[x_(0) + t_(x)], [y_(0) + t_(y)], [z_(0) + t_(z)]] sqrt(d)"
        expect(formula.to_latex).to eq(latex)
        expect(formula.to_mathml(split_on_linebreak: true)).to be_equivalent_to(mathml)
        expect(formula.to_asciimath).to eq(asciimath)
      end
