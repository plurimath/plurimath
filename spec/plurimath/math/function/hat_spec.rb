...
RSpec.describe Plurimath::Math::Function::Hat do
  ...
  describe ".to_asciimath" do
    ...
    context "contains Formula as value" do
      ...
      it "returns asciimath string" do
        expect(formula).to eq("hat(sum_(&)^(\"so\"))")
      end
    end
  end
  ...
  describe ".to_latex" do
    ...
    context "contains Formula as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("\\hat{\\sum_{&}^{\\text{so}}}")
      end
    end
  end
  ...
  describe ".to_html" do
    ...
    context "contains Symbol as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("<i>hat</i><i>n</i>")
      end
    end
    ...
    context "contains Number as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("<i>hat</i><i>70</i>")
      end
    end
    ...
    context "contains Formula as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("<i>hat</i><i><i>&sum;</i><sub>&</sub><sup>so</sup></i>")
      end
    end
  end
