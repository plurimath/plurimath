    ...
    module Function
      class BinaryFunction < Core
        ...
        def to_asciimath(options:)
          "#{class_name}#{wrapped(parameter_one,
                                  options: options)}#{wrapped(parameter_two,
                                                              options: options)}"
        end
        ...
        def to_latex(options:)
          if parameter_one
            first_value = latex_wrapped(parameter_one,
                                        options: options)
          end
          if parameter_two
...
options:)
        ...
        def underover(display_style, options:)
          ...
          if !display_style
            power_base = PowerBase.new(first_value, parameter_one,
                                       parameter_two)
          ...
          unless parameter_one
            return Array(overset.to_omml_without_math_tag(display_style,
                                                          options: options))
          end
