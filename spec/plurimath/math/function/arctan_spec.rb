...
RSpec.describe Plurimath::Math::Function::Arctan do
  describe ".initialize" do
    it "returns instance of Arctan" do
      arctan = described_class.new("70")
      expect(arctan).to be_a(described_class)
    end
  ...
  describe ".to_asciimath" do
    ...
    context "contains Formula as value" do
      ...
      it "returns asciimath string" do
        expect(formula).to eq("arctansum_(&)^(\"so\")")
      end
    end
  end
  ...
  describe ".to_latex" do
    ...
    context "contains Symbol as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("\\arctan{n}")
      end
    end
    ...
    context "contains Number as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("\\arctan{70}")
      end
    end
    ...
    context "contains Formula as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("\\arctan{\\sum_{\\&}^{\\text{so}}}")
      end
    end
  end
  ...
  describe ".to_html" do
    ...
    context "contains Symbol as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("<i>arctan</i><i>n</i>")
      end
    end
    ...
    context "contains Number as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("<i>arctan</i><i>70</i>")
      end
    end
    ...
    context "contains Formula as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("<i>arctan</i><i><i>&sum;</i><sub>&</sub><sup>so</sup></i>")
      end
    end
  end
