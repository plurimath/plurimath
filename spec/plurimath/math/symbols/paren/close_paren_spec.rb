...
RSpec.describe Plurimath::Math::Symbols::Paren::CloseParen do

  describe ".initialize" do
    it 'returns instance of paren symbol CloseParen' do
      klass = described_class.new
      expect(klass).to be_a(Plurimath::Math::Symbols::Paren::CloseParen)
    end
  end
  ...
  describe ".open?, .close?, .opening" do
    ...
    context "matches if open paren for the Symbol Plurimath::Math::Symbols::Paren::CloseParen" do
  ...
  describe "All language conversion specs" do
    ...
    context "Matches all conversion for the Symbol Plurimath::Math::Symbols::Paren::CloseParen" do
      it "matches AsciiMath paren string" do
        expect(klass.to_asciimath).to eq(":}")
      end

      it "matches LaTeX paren string" do
        expect(klass.to_latex).to eq("\\right.")
      end
