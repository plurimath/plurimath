      ...
      class Underset < BinaryFunction
        ...
        def to_unicodemath(options:)
          ...
          if unicode_classes_accent?(parameter_two)
            return "#{parameter_two.to_unicodemath(options: options)}_#{unicodemath_parens(
          ...
          "#{unicodemath_parens(parameter_two,
                                options: options)}┬#{parameter_one.to_unicodemath(options: options)}"
        end
        ...
        def new_nary_function(fourth_value)
          Nary.new(parameter_two, parameter_one, nil, fourth_value,
                   { type: "undOvr" })
        end
