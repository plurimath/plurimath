...
RSpec.describe Plurimath::Math::Function::Csc do
  describe ".initialize" do
    it "returns instance of Csc" do
      csc = described_class.new("70")
      expect(csc).to be_a(described_class)
    end

    it "initializes Csc object" do
      csc = described_class.new("70")
      expect(csc.parameter_one).to eql("70")
    end
  end
  ...
  describe ".to_asciimath" do
    ...
    context "contains Formula as value" do
      ...
      it "returns asciimath string" do
        expect(formula).to eq("cscsum_(&)^(\"so\")")
      end
    end
  end
  ...
  describe ".to_latex" do
    ...
    context "contains Formula as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("\\csc{\\sum_{\\&}^{\\text{so}}}")
      end
    end
  end
  ...
  describe ".to_html" do
    ...
    context "contains Symbol as value" do
      ...
      it "returns html string" do
        expect(formula).to eql("<i>csc</i><i>n</i>")
      end
    end
    ...
    context "contains Number as value" do
      ...
      it "returns html string" do
        expect(formula).to eql("<i>csc</i><i>70</i>")
      end
    end
    ...
    context "contains Formula as value" do
      ...
      it "returns html string" do
        expect(formula).to eql("<i>csc</i><i><i>&sum;</i><sub>&</sub><sup>so</sup></i>")
      end
    end
  end
