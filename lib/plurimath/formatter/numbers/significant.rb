...
module Plurimath
  module Formatter
    module Numbers
      class Significant
        attr_accessor :symbols, :significant
        ...
        def round_str(chars, array, frac_part)
          ...
          frac_part = false if chars[arr_len] == "."
          prev_ten  = false
