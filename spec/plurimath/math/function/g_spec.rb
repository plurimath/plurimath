...
RSpec.describe Plurimath::Math::Function::G do
  ...
  describe ".to_latex" do
    ...
    context "contains Formula as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("g\\sum_{&}^{\\text{so}}")
      end
    end
  end
  ...
  describe ".to_html" do
    ...
    context "contains Symbol as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("<i>g</i><i>n</i>")
      end
    end
    ...
    context "contains Number as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("<i>g</i><i>70</i>")
      end
    end
    ...
    context "contains Formula as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("<i>g</i><i><i>&sum;</i><sub>&</sub><sup>so</sup></i>")
      end
    end
  end
end
