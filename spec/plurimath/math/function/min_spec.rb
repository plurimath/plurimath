...
RSpec.describe Plurimath::Math::Function::Min do
  describe ".initialize" do
    it "returns instance of Min" do
      min = described_class.new([70, 3])
      expect(min).to be_a(described_class)
    end

    it "initializes Min object" do
      min = described_class.new([70, 3])
      expect(min.parameter_one).to eql([70, 3])
    end
  end
  ...
  describe ".to_asciimath" do
    ...
    context "contains Formula as value" do
      ...
      it "returns asciimath string" do
        expect(formula).to eq("minsum_(&)^(\"so\")")
      end
    end
  end
  ...
  describe ".to_latex" do
    ...
    context "contains Formula as value" do
      ...
      it "returns mathml string" do
        expect(formula).to eql("\\min{\\sum_{\\&}^{\\text{so}}}")
      end
    end
  end
  ...
  describe ".to_html" do
    ...
    context "contains Symbol as value" do
      ...
      it "returns html string" do
        expect(formula).to eql("<i>min</i><i>n</i>")
      end
    end
    ...
    context "contains Number as value" do
      ...
      it "returns html string" do
        expect(formula).to eql("<i>min</i><i>70</i>")
      end
    end
    ...
    context "contains Formula as value" do
      ...
      it "returns html string" do
        expect(formula).to eql("<i>min</i><i><i>&sum;</i><sub>&</sub><sup>so</sup></i>")
      end
    end
  end
