...
RSpec.describe Plurimath::Math::Symbols::Nsqsuperseteq do

  describe ".initialize" do
    it 'returns instance of Symbol Nsqsuperseteq' do
      klass = described_class.new
      expect(klass).to be_a(Plurimath::Math::Symbols::Nsqsuperseteq)
    end
  end
